...
// import_entry
router.get('/', import_exportController.listAllImportData)
router.get('/:id', import_exportController.listImportData)
router.get('/', import_exportController.listAllImportProduct)
router.get('/:id', import_exportController.listImportProduct)
...
router.get('/:id', import_exportController.listExportData)
router.get('/', import_exportController.listAllExportProduct)
router.get('/:id', import_exportController.listExportProduct)
